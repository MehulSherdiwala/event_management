...
if ($(".ourImg").length) {
	...
	var ImgName = imgPath.split("/")[3];
	$(".ourImg").css({"background":"url('assets/images/about-us/"+ ImgName +"')no-repeat center top"});
}
...
if ($(".event-gallerSlider").length == 1) 
{
	$(".event-gallerSlider").owlCarousel({
		...
		dots: false,
		nav:true,
		navText: [ '<img src="assets/images/service-gallerLeft-arrow.png">', '<img src="assets/images/service-gallerRight-arrow.png">' ],
		responsive:{
			0:{
				items:1
			},
