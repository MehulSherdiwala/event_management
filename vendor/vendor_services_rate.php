...
$vendorServiceList = $vendor_service->getVendorServiceRate($_SESSION['vendor_id']);
?>
			...
			<div class="page-content">
				<div class="page-bar">
					<div class="page-title-breadcrumb">
						<div class=" pull-left">
							<div class="page-title">Vendor Ratings</div>
						</div>
						<ol class="breadcrumb page-breadcrumb pull-right">
							<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
																   href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
							</li>
							<li class="active">Vendor Ratings</li>
						</ol>
					</div>
				</div>
				<div class="row">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="card card-topline-lightblue">
									<div class="card-head">
										<header>Vendor Rating List</header>
										<div class="tools">
									...
									<div class="card-body ">
										<div class="table-scrollable">
											<table class="table table-bordered table-striped" id="vendor_service">
												<thead>
												<tr>
													<th>Vendor Service Ratting Id</th>
													<th>User Name</th>
													<th>Service Name</th>
													<th>Rates</th>
												</tr>
												...
												foreach ($vendorServiceList as $row)
												{
													?>
													<tr>
														<td><?= $row['vendor_service_rate_id']?></td>
														<td><?= $row['user_name']?></td>
