                                        ...
                                        <div class="text">
                                            ...
                                            <div class="outher-info">
                                                ...
                                                <div class="info-slide">
                                                    ...
                                                    <div class="star">
                                                        <div class="fill" style="width:calc(<?= $vendor->getVendorRate($item['vendor_id'],TRUE) ?> * 20%);"></div>
                                                    </div>
                                                ...
                                                <div class="info-slide">
                                                    ...
                                                    <div class="star">
                                                        <div class="fill" style="width:calc(<?= $service->getVendorServiceRate($item['vendor_id'], TRUE) ?> * 20%);"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="button">
                                                ...
                                                <a href="vendor_services.php" class="btn btn-success">Chat</a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
