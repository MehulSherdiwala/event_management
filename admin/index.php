			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 col-12 col-sm-6">
						<div class="blogThumb">
							<div class="thumb-center"><img class="img-responsive" alt="user"
														   src="<?= base_url ?>assets/img/course/course1.jpg"></div>
					...
					<div class="col-lg-3 col-md-6 col-12 col-sm-6 ">
						<div class="blogThumb">
							<div class="thumb-center"><img class="img-responsive" alt="user"
														   src="<?= base_url ?>assets/img/course/course2.jpg"></div>
							<div class="course-box">
								<h4>PHP Development Course</h4>
								<div class="text-muted"><span class="m-r-10">April 23</span>
									<a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i> 654</a>
					...
					<div class="col-lg-3 col-md-6 col-12 col-sm-6">
						<div class="blogThumb">
							<div class="thumb-center"><img class="img-responsive" alt="user"
														   src="<?= base_url ?>assets/img/course/course3.jpg"></div>
							<div class="course-box">
								<h4>PHP Development Course</h4>
								<div class="text-muted"><span class="m-r-10">April 23</span>
									<a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i> 654</a>
					...
					<div class="col-lg-3 col-md-6 col-12 col-sm-6">
						<div class="blogThumb">
							<div class="thumb-center"><img class="img-responsive" alt="user"
														   src="<?= base_url ?>assets/img/course/course4.jpg"></div>
							<div class="course-box">
								<h4>PHP Development Course</h4>
								<div class="text-muted"><span class="m-r-10">April 23</span>
									<a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i> 654</a>
								...
								<ul class="feedBody">
									<li class="active-feed">
										<div class="feed-user-img">
											<img src="<?= base_url ?>assets/img/std/std1.jpg" class="img-radius "
									...
									<li class="diactive-feed">
										<div class="feed-user-img">
											<img src="<?= base_url ?>assets/img/std/std2.jpg" class="img-radius "
												 alt="User-Profile-Image">
										</div>
										<h6>
									...
									<li class="diactive-feed">
										<div class="feed-user-img">
											<img src="<?= base_url ?>assets/img/std/std3.jpg" class="img-radius "
												 alt="User-Profile-Image">
										</div>
										<h6>
									...
									<li class="active-feed">
										<div class="feed-user-img">
											<img src="<?= base_url ?>assets/img/std/std4.jpg" class="img-radius "
												 alt="User-Profile-Image">
										</div>
										<h6>
									...
									<li class="active-feed">
										<div class="feed-user-img">
											<img src="<?= base_url ?>assets/img/std/std5.jpg" class="img-radius "
												 alt="User-Profile-Image">
										</div>
										<h6>
											<span class="feedLblStyle lblFileStyle">File</span> Sarah Smith <small
									...
									<li class="diactive-feed">
										<div class="feed-user-img">
											<img src="<?= base_url ?>assets/img/std/std6.jpg" class="img-radius "
												 alt="User-Profile-Image">
										</div>
										<h6>
											<span class="feedLblStyle lblTaskStyle">Task </span> Jalpa Joshi<small
...
<script src="<?= base_url ?>assets/js/pages/chart/chartjs/home-data.js"></script>
<!-- summernote -->
