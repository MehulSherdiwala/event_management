											...
											<table class="table table-bordered table-striped" id="user">
												...
												foreach ($userList as $row)
												{
													...
													<tr>
														...
														<td>
															<button type="button" class="btn btn-info btn-sm edit_user" data-eid="<?= $row['user_id']?>" data-toggle="modal" data-target="#edit_user"><i class="fa fa-pencil"></i></button>
														</td>
													</tr>
													<?php
												}
...
<div class="modal fade" id="edit_user" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form action="<?= base_url?>admin/user_action.php" method="post">
				...
				<div class="modal-body">
					<div class="form-group">
						<label>Status : </label>
						<input type="hidden" name="user_edit" id="1">
...
<script>
    ...
    $(".edit_user").on('click', function (){
        ...
        $.ajax({
            url: '<?= base_url?>model/user.php?ajax=true&user=status&user_id='+id,
