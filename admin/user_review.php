			...
			<div class="page-content">
				<div class="page-bar">
					<div class="page-title-breadcrumb">
						<div class=" pull-left">
							<div class="page-title">User Reviews</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="card card-topline-lightblue">
									<div class="card-head">
										<header>User Review List</header>
										<div class="tools">
											...
											<table class="table table-bordered table-striped" id="user">
												...
												foreach ($userList as $row)
												{
													...
													<tr>
														...
														<td><?= $row['review']?></td>
														<td>
															<a href="<?= base_url?>admin/user_action.php?user_review_delete=true&user_review_id=<?= $row['user_review_id']?>"  class="btn btn-danger btn-sm delete_event"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
													<?php
												}
