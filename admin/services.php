								...
								<div class="card card-topline-lightblue">
									...
									<div class="card-body ">
										<div class="float-right mb-2">
											<button type="button" class="btn btn-success" data-toggle="modal" data-target="#add_service">Add Service</button>
										</div>
											...
											<table class="table table-bordered table-striped" id="service">
												...
												foreach ($servicesList as $row)
												{
													...
													<tr>
														...
														<td>
															<button type="button" class="btn btn-info btn-sm edit_service" data-eid="<?= $row->service_id?>" data-toggle="modal" data-target="#edit_service"><i class="fa fa-pencil"></i></button>
															<a href="<?= base_url?>admin/services_action.php?service_delete=true&service_id=<?= $row->service_id?>"  class="btn btn-danger btn-sm delete_service"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
													<?php
												}
...
<div class="modal fade" id="add_service" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form action="<?= base_url?>admin/services_action.php" method="post" enctype="multipart/form-data">
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="text" name="service_name" class="form-control" placeholder="Service" required>
						<input type="hidden" name="service_add" value="1">
					</div>
					<div class="form-group">
						<label>Image : </label>
		...
		<div class="modal-content">
			<form action="<?= base_url?>admin/services_action.php" method="post" enctype="multipart/form-data">
				...
				<div class="modal-body">
					<div class="form-group">
						<label>Service Name : </label>
						<input type="text" name="service_name" id="service_name" class="form-control" placeholder="Service" required>
...
<script>
    ...
    $(".edit_service").on('click', function (){
        ...
        $.ajax({
            url: '<?= base_url?>model/services.php?ajax=true&service_id='+id,
