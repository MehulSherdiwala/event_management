...
$vendorList = $vendor->getVendorReivew();
?>
											...
											<table class="table table-bordered table-striped" id="vendor">
												...
												foreach ($vendorList as $row)
												{
													...
													<tr>
														...
														<td><?= $row['review']?></td>
														<td>
															<a href="<?= base_url?>admin/vendor_action.php?vendor_review_delete=true&vendor_review_id=<?= $row['vendor_review_id']?>"  class="btn btn-danger btn-sm delete_event"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
													<?php
												}
