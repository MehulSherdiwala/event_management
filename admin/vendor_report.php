...
if ($report_type == 1){
	...
	$title = "Vendor Status Wise";
	$vendorList = $vendor->getStatusWiseVendors($_POST['status']);
} elseif ($report_type == 3){
	$title = "Vendor Location Wise";
	$vendorList = $vendor->getLocWiseVendors($_POST['country_id'], $_POST['state_id'], $_POST['city_id']);
}
//echo "<pre>";
//print_r ($vendorList);
//echo "</pre>";
